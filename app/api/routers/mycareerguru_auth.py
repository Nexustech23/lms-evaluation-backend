# ============================================================
# MYCAREERGURU PUBLIC REGISTRATION
#
# A separate, unauthenticated entry point for individual students signing
# up directly at the MyCareerGuru landing page — distinct from /register
...
# CLAUDE.md/the MyCareerGuru rollout plan for why approval-gating (not
...
from app.core.rate_limit import mycareerguru_register_rate_limit
from app.core.security import hash_password
from app.db.mongodb import get_database
from app.schemas.auth import RegisterSelfLearner

router = APIRouter(prefix="/mycareerguru", tags=["mycareerguru-auth"])


@router.post("/register", dependencies=[Depends(mycareerguru_register_rate_limit)])
async def mycareerguru_register(
